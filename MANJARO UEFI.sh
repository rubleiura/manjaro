...
clear
pacman -Syy
pacman -S --noconfirm grub grub-btrfs efibootmgr os-prober grub-theme-manjaro
...
clear
# "=====  Установка системных утилит и библиотек ====="
pacman -S --noconfirm glibc-locales man-db man-pages manjaro-system sudo less vi nano micro nano-syntax-highlighting which perl python-pillow python-pip python-pyqt5 python-pysmbc python-reportlab diffutils rsync wget texinfo logrotate usbutils pciutils usb_modeswitch sysfsutils inxi fastfetch htop powertop cpupower dmidecode lib32-libcanberra libcanberra lib32-mesa lib32-mesa-utils mesa-utils libva-intel-driver lib32-libva-intel-driver xdg-user-dirs xdg-utils s-nail cronie

# "=====  Установка сервера X Window System и драйверов ====="
...
# "=====  Установка управления дисками и файловыми системами ====="
pacman -S --noconfirm btrfs-progs dosfstools e2fsprogs exfatprogs f2fs-tools jfsutils xfsprogs ntfs-3g cryptsetup device-mapper lvm2 mdadm dmraid udisks2 udiskie udev-usb-sync

# "=====  Установка сетевых утилит и сервисов ====="
pacman -S --noconfirm networkmanager networkmanager-l2tp networkmanager-openconnect networkmanager-openvpn networkmanager-vpnc wpa_supplicant wireless-regdb openssh nfs-utils avahi nss-mdns dnsmasq inetutils samba sshfs modemmanager manjaro-modem

# "=====  Установка звуковых систем и кодеков ====="
pacman -S --noconfirm alsa-firmware alsa-utils manjaro-alsa manjaro-pipewire sof-firmware gst-libav gst-plugins-base gst-plugins-good gst-plugins-bad gst-plugins-ugly

# "=====  Установка графической среды KDE Plasma ====="
pacman -S --noconfirm plasma-desktop plasma-workspace plasma-workspace-wallpapers plasma-nm plasma-pa plasma-systemmonitor plasma-thunderbolt plasma-browser-integration kde-gtk-config kdegraphics-thumbnailers kdenetwork-filesharing kdeplasma-addons bluedevil breeze5 breeze-gtk kwayland-integration kwin kscreen kscreenlocker kwrited powerdevil sddm sddm-breath-theme sddm-kcm systemsettings kgamma kmenuedit kinfocenter khelpcenter ksshaskpass kwallet-pam kwalletmanager ksystemlog kfind keditbookmarks milou yakuake konsole dolphin dolphin-plugins gwenview okular ark spectacle kate kcalc print-manager skanlite kamera kaccounts-providers kio-extras kimageformats audiocd-kio xdg-desktop-portal-kde
...
# "=====  Установка менеджера пакетов Pamac ====="
pacman -S --noconfirm pamac-cli pamac-gtk3 pamac-tray-icon-plasma libpamac-flatpak-plugin

# "=====  Установка утилит Manjaro ====="
pacman -S --noconfirm manjaro-hello manjaro-kde-settings manjaro-application-utility manjaro-browser-settings manjaro-gstreamer manjaro-release manjaro-settings-manager-knotifier manjaro-zsh-config

# "=====  Установка утилит обслуживания и безопасности ====="
pacman -S --noconfirm timeshift timeshift-autosnap-manjaro mhwd mhwd-db acpi acpid numlockx b43-fwcutter fwupd sbctl open-vm-tools virtualbox-guest-utils qemu-guest-agent spice-vdagent filelight unarchiver 7zip mtpfs perl-file-mimeinfo poppler-data libdvdcss power-profiles-daemon gtk3 gtkmm3 qt6-imageformats qt6-virtualkeyboard

# "=====  Установка принтеров и сканеров ====="
pacman -S --noconfirm manjaro-printer system-config-printer
# Примечание: Для полноценной работы принтеров также требуется установка CUPS, которая часто устанавливается как зависимость.

# "=====  Включение и запуск ключевых системных сервисов ====="
# В chroot systemctl может не работать напрямую для запуска сервисов,
# но enable записывает их в конфигурацию, чтобы они запускались при загрузке реальной системы.
...
pacman -S --noconfirm micro nano-syntax-highlighting
