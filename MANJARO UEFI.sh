...
# ######################################################
# ## 🌌 БЛОК 9: УСТАНОВКА ГРАФИЧЕСКОЙ СРЕДЫ ###########
# ######################################################
#
...
pacman -S --noconfirm pamac-cli pamac-gtk pamac-tray-icon-plasma libpamac-flatpak-plugin
...
# ########################################################
# ## 🔐 БЛОК 11: HOSTNAME И ПАРОЛЬ ROOT (chroot) #########
# ########################################################
#
...
# #######################################################
# ## 👤 БЛОК 12: ПОЛЬЗОВАТЕЛЬ И SUDO (chroot) ###########
# #######################################################
#
